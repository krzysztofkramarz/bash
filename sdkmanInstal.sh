...
echo "sdkman_insecure_ssl=true" >> "$sdkman_config_file"
...
echo "Masz minutę na pobranie pliku pod tym linkiem:"
echo https://epam-my.sharepoint.com/:u:/p/jakub_czajka/ERcE-wsSSbRGqGEpjXbKsP4BPziRXTDLOUjc-LJV8yDugw?e=eQUlW9
echo "Wskazówka: wciśnij Control i klepnij link powyżej! Wymagane konto Epamowe."
echo "Jeśli już pobrałeś plik - zignoruj ten komunikat"
sleep 60

sdkman_zip_file="sdkman-cli-5.7.3+337.zip"
